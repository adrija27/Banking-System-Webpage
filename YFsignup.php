...
<div class="row margin">
    <div class="col-md-offset-4 col-md-4 ">
        <div class="panel panel-default">
            ...
            <form  method="post" action="ctrl_signup_script.php" >
                ...
                <div class="form-group">
                    <button type="submit" value="SignUp" class="btn btn-block btn-success">Signup</button>
                </div>
            </form>    
        </div>  
        <div class="panel-footer" >
            <p>Already have an account ? <a href="YFlogin.php"> Click here to Log In</a></p>
        </div>  
    </div>  
</div>
</div>
