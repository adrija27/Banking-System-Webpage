  ...
  <div class="row content">
    ...
    <form method="post" action="deposit_script.php">
      <div class="form-group">
              ...
              <input type="number" name="val" class="form-control" placeholder="INR" >
                </div>
                <div class="form-group">
                  <label for=b_name>From Bank Name</label>
                  <input type="txt" name="b_name" class="form-control" placeholder="Bank Name" >
                </div>
                <div class="form-group">
                  <label for="to">From Account Number</label>
                  <input type="number" name="to" class="form-control" placeholder="Account Number" ><br>
                </div>
                <div class="form-group">
                  <button type="submit" value="Payment" class="btn btn-block btn-success">Add Balance</button>
                </div>
    </form>
    <?php } 
    } ?>
